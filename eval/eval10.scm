    ...
    (let ((head (car exp))
      ...
      (cond
       ...
       ((eq? head 'define)
        ...
        (begin (define body-forms (cdr args)) (assert (or is-procedure? (= 1 (length body-forms)))))

        (define binding (frame-lookup (environment-current-frame env) name))
        ...
        (define new-value (internal-eval
                           (if is-procedure?
